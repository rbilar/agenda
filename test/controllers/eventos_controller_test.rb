...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { inicio: @evento.inicio, local: @evento.local, nome: @evento.nome, termino: @evento.termino } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { inicio: @evento.inicio, local: @evento.local, nome: @evento.nome, termino: @evento.termino } }
